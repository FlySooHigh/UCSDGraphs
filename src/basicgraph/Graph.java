...
//		--------------------------------------------------
		GraphAdjList graphListFromFile = new GraphAdjList();
        GraphLoader.loadRoadMap("data/testdata/simpletest.map", graphListFromFile);
//		System.out.println(graphFromFile);

        System.out.println("---------");
        System.out.println(graphListFromFile.adjacencyString());

        System.out.println("---------");
        System.out.println(graphListFromFile.degreeSequence());

        System.out.println("---------");
        System.out.println(graphListFromFile.getDistance2(1));
...
//		--------------------------------------------------
        ...
        System.out.println(graphMatrixFromFile.adjacencyString());
        System.out.println("---------");
        System.out.println(graphMatrixFromFile.degreeSequence());
        System.out.println("---------");
        System.out.println(graphMatrixFromFile.getDistance2(1));
